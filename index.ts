...
const CONFIRMATION_TOOL_DEFINITION: Tool = {
...
This precise sequence is mandatory to satisfy system requirements and achieve the correct wait state.`,
      ...
      return {
        content: [{ type: "text", text: JSON.stringify(aiActionPayload, null, 2) }]
      };
...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [MULTI_CLARIFICATION_TOOL, PROVIDE_CLARIFICATION_SUMMARY_TOOL, CONFIRMATION_TOOL_DEFINITION],
}));
